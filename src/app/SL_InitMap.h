...
public:
	...
	Mat_d m_siftPts[SLAM_MAX_NUM]; //key points after removing the distortion
	Mat_d m_siftPts_undist[SLAM_MAX_NUM]; //key points on normalized image planes
	...
	std::vector<vector<cv::KeyPoint> > keypoints;
	...
	Track2D m_siftTracks[SLAM_MAX_TRACKNUM];
...
public:
	...
	bool computeExtrinsic();
	bool computeExtrinsic_new();
	bool computeExtrinsic_5pts();

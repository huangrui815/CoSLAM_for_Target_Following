...
//		double area = getPolyArea(cxh);
//		if (area < 0.25 * imgW[jCam] * imgH[jCam])
//			return false;

//check how many points are in the convex hull
...
int MergeCameraGroup::matchFeaturePointsNCC(int iCam, int jCam,
	...
	//save the data;
//	Mat_d pts1, pts2;
//	vecFeatPt2Mat(featPts1, pts1);
//	vecFeatPt2Mat(featPts2, pts2);
//	writeMat(pts1, "/home/tsou/NCCMatching/pts1.txt");
//	writeMat(pts2, "/home/tsou/NCCMatching/pts2.txt");
//	writeMat(surfPts1, "/home/tsou/NCCMatching/seed_pts1.txt");
//	writeMat(surfpts2, "/home/tsou/NCCMatching/seed_pts2.txt");
//	write(surfMatches, "/home/tsou/NCCMatching/seed_match.txt");
//
//	imwrite(m_pCurKeyFrm->pPose[iCam]->img, "/home/tsou/NCCMatching/img1.bmp");
//	imwrite(m_pCurKeyFrm->pPose[iCam]->imgSmall,
//			"/home/tsou/NCCMatching/simg1.bmp");
//	imwrite(m_pCurKeyFrm->pPose[jCam]->img, "/home/tsou/NCCMatching/img2.bmp");
//	imwrite(m_pCurKeyFrm->pPose[jCam]->imgSmall,
//			"/home/tsou/NCCMatching/simg2.bmp");
...
//	writeMat(3, 3, F, "/home/tsou/NCCMatching/F.txt");
...
//	ImgRGB outImg;
//	Mat_d mpts1, mpts2;
//	getMatchedPts(featMatches, fpts1, fpts2, mpts1, mpts2);
//	drawMatching(m_pCurKeyFrm->pPose[iCam]->img, mpts1,
//			m_pCurKeyFrm->pPose[jCam]->img, mpts2, outImg, 1.0, 0);
//
//	imwrite(outImg, "/home/tsou/outImg.bmp");
//	imshowext("NCC matches", outImg);
...
//	for (int n = 0; n < nPose; ++n) {
//		KeyPose* pose = order_to_pose[n];
//		imwrite(pose->img, "/home/tsou/test/img%d.bmp", n);
//	}
...
//	vector<pair<int, int> > camPairs;
//	for (int i = 0; i < m_nMergeInfo; i++) {
//		if (m_mergeInfo[i].valid == true
//				&& (m_mergeInfo[i].frame1 == m_pCurKeyFrm->f
//						&& m_mergeInfo[i].frame2 == m_pCurKeyFrm->f)) {
//			//matched cameras in the current key frame
//			camPairs.push_back(
//					make_pair(m_mergeInfo[i].camId1, m_mergeInfo[i].camId2));
//		}
//	}
//	int firstFrameForConstraint = m_pFirstConstrainFrm->f;
//
//	int n = 0;
//	for (KeyFrame* kf = m_pCurKeyFrm; kf && n <= nMaxKeyFrms; kf = kf->prev) {
//		size_t nSameGroup = 0;
//		for (int g = 0; g < kf->nGroup; g++)
//			for (size_t i = 0; i < camPairs.size(); i++)
//				if (kf->camGroups[g].isCameraIn(camPairs[i].first)
//						&& kf->camGroups[g].isCameraIn(camPairs[i].second))
//					nSameGroup++;
//
//		//if all the separated cameras are in the same group
//		if ((nSameGroup == camPairs.size() && kf->f < firstFrameForConstraint)
//				|| n == nMaxKeyFrms) {
